...
router.post('/data', (req, res) => {
  ...
  if (temperature !== undefined && pulse !== undefined) {
    const newData = new sensorData({
      temperature: temperature.toString(), // Convert temperature to string to match the schema
      pulseRate: pulse.toString(), // Convert pulse to string to match the schema
    });
    ...
    newData
      ...
      .then(() => {
        ...
        // Check if temperature is greater than 37 or pulse is greater than 120
